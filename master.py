...
def main():
    ...
    # File paths
    equity_data_file = "/Users/davidhoward/FINM3411/equitysheet2.csv"
    capital_structure_file = "/Users/davidhoward/FINM3411/DV and EV.csv"
...
class RIOBetaAnalyzer:
    ...
    def calculate_weekly_returns(self, data, period_years=None):
...
METHODOLOGY:
• Company-specific: Weighted beta across 10Y/5Y/3Y periods with zero-return filtering
...
"The blended approach combines RIO-specific systematic risk with industry validation 
through rigorous unlevering/relevering, providing a robust estimate for WACC calculation."
        """
    ...
    def run_complete_analysis(self):
        ...
        try:
            ...
            for years, name in periods:
                weekly_returns = self.calculate_weekly_returns(clean_data, years)
